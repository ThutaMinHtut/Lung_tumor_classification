...
# Directories
train_dir = "[PLACEHOLDER]/train" 
valid_dir = "[PLACEHOLDER]/valid"
test_dir = "[PLACEHOLDER]/test"
...
save_path = "[PLACEHOLDER_B].PTH" #NAME TO SAVE BEST MODEL
# Train the model
train_model(model, train_loader, valid_loader, criterion, optimizer,scheduler, epochs=150,save_path=save_path)

#################################################################################################
model.load_state_dict(torch.load("[PLACEHOLDER_B].pth", weights_only=True)) #NAME TO SAVE BEST MODEL
model.eval()
correct = 0
total = 0
